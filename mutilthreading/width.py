...
class get_model(nn.Module):
    def __init__(self, mlp_list=[64,64,64,128,1024], linear_list=[512,256,1], num_category=5, normal_channel=True):
...
if __name__ == '__main__':
    ...
    # The time used to calculated is  0.02400493621826172 s when point is 1024
    # The time used to calculated is  0.1000223159790039 s  when point is 1024*5